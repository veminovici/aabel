...
module MappR =
    ...
    type Instruction<'TKey, 'TValue, 'a, 'TErr> =
        | Add    of ('TKey * 'TValue) list * (Result<unit, 'TErr> -> 'a)
        | Del    of 'TKey list             * (Result<unit, 'TErr> -> 'a)
        | Find   of 'TKey list             * (Result<('TKey * 'TValue) list, 'TErr> -> 'a)
    ...
    let fold
        ...
        (add:    ('TKey * 'TValue) list -> StateR<'S, unit, 'TErr>)
        (del:    'TKey list             -> StateR<'S, unit, 'TErr>)
        (find:   'TKey list             -> StateR<'S, ('TKey * 'TValue) list, 'TErr>)
        (isFull: unit                   -> StateR<'S, bool, 'TErr>)
        (flow: Program<'TKey, 'TValue, 'a, 'TErr>) : StateR<'S, 'b, 'TErr> =
