# Simplee |> Aabel |> Queue
The implementation of the **Queue** monad and some of its variations: **QueueR** a queue where its operations return a **Result** value and the bind function takes case of the error cases.
...
- Computation expression: **_queueR**
...
More examples: [QtQueueR.fsx](https://github.com/veminovici/aabel/blob/main/tests/Scripts/QtQueueR.fsx)
